...
//        $(this).find('.circleText').html(parseInt(50 * progress) + '<span style="font-size: 20px;">%</span>');
//    });
//    $('.skill2').circleProgress({
//        value: parseFloat(60) / 100, //補資料
//        size: 150.0,
//        startAngle: -Math.PI / 2,
//        thickness: 8,
//        emptyFill: 'rgba(0,0,0,0)',
//        fill: { gradient: ['#FFF', '#FFF'] },
//}).on('circle-animation-progress', function(event, progress) {
//        $(this).find('.circleText').html(parseInt(60 * progress) + '<span style="font-size: 20px;">%</span>');
//    });
//    $('.skill3').circleProgress({
//        value: parseFloat(70) / 100, //補資料
//        size: 150.0,
//        startAngle: -Math.PI / 2,
//        thickness: 8,
//        emptyFill: 'rgba(0,0,0,0)',
//        fill: { gradient: ['#FFF', '#FFF'] },
//}).on('circle-animation-progress', function(event, progress) {
//        $(this).find('.circleText').html(parseInt(70 * progress) + '<span style="font-size: 20px;">%</span>');
//    });
//    $('.skill4').circleProgress({
//        value: parseFloat(80) / 100, //補資料
//        size: 150.0,
//        startAngle: -Math.PI / 2,
//        thickness: 8,
//        emptyFill: 'rgba(0,0,0,0)',
//        fill: { gradient: ['#FFF', '#FFF'] },
//}).on('circle-animation-progress', function(event, progress) {
//        $(this).find('.circleText').html(parseInt(80 * progress) + '<span style="font-size: 20px;">%</span>');
//    });
//}
