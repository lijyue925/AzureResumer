...
$(".word2")
  .mouseenter(function () {
      $(".button2").css("background", "#00A99D");
  })
  .mouseleave(function () {
      $(".button2").css("background", "");
  });

$(".word3")
  .mouseenter(function () {
      $(".button3").css("background", "#00A99D");
  })
  .mouseleave(function () {
      $(".button3").css("background", "");
  });

$(".word4")
  .mouseenter(function () {
      $(".button4").css("background", "#00A99D");
  })
  .mouseleave(function () {
      $(".button4").css("background", "");
  });
                    ...
                    if( states[i].top > windowtop && states[i].top < windowbtm )
                    {
                        ...
                        if (i == 3 && stop == 0) {
                            $('.skill1').circleProgress({
                                ...
                                thickness: 20,
                                emptyFill: 'rgba(225,255,255,1)',
                                fill: { gradient: ['#00A99D'] },
                            }).on('circle-animation-progress', function (event, progress) {
                                $(this).find('.circleText').html(parseInt(10 * progress) + '<i>%</i>');
                            });
                            $('.skill2').circleProgress({
                                ...
                                $(this).find('.circleText').html(parseInt(50 * progress) + '<i>%</i>');
                            });
